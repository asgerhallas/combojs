      ...
      Combo.prototype.load = function(source) {
        ...
        this.source = (function() {
          ...
          for (_i = 0, _len = source.length; _i < _len; _i++) {
            item = source[_i];
            fixedItem = {
              litra: evaluate(this.litraField, item),
              value: evaluate(this.valueField, item),
              display: evaluate(this.displayField, item),
              title: this.stripMarkup((title = evaluate(this.titleField, item)) ? title : evaluate(this.displayField, item)),
              enabled: evaluate(this.enabledField, item)
            };
            _ref = this.modifiers;
      ...
      Combo.prototype.renderList = function(items, filters) {
        ...
        for (index = _i = 0, _len = items.length; _i < _len; index = ++_i) {
          ...
          if (!_.all(filters, function(filter) {
            return filter.predicate(item[filter.property]);
          })) {
            continue;
          }
