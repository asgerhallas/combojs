  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      function Combo(wrapper, options) {
        ...
        this.input = $("<input type='text' class='combo-input' autocomplete='off' disabled='disabled' spellcheck='" + this.spellcheck + "' " + (this.tabIndex != null ? 'tabindex=\'@tabIndex\'' : '') + " style='width: " + (width - 46) + "px' />").bind({
