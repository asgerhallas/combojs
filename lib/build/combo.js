  ...
  (function($, window) {
    ...
    this.Combo = (function() {
      ...
      function Combo(wrapper, options) {
        ...
        this.container = $('<div class="combo-container" />');
        $(wrapper).append(this.container);
        this.inputContainer = $('<div class="combo-input-container" />').appendTo(this.container);
        this.input = $('<input type="text" class="combo-input" autocomplete="off" disabled="disabled"/>').attr('spellcheck', this.spellcheck).appendTo(this.inputContainer).bind({
        ...
        this.button = $('<button class="combo-button" tabindex="-1" disabled="disabled" />').insertAfter(this.inputContainer).bind({
          click: this.onButtonClick,
          mousedown: this.suppressNextBlur
        });
        this.listContainer = $('<div class="combo-list-container" />').css({
          maxHeight: 0
        ...
        this.container.on('click', '.combo-list li', this.onListClick);
        if ($.fn.bgiframe) {
          this.list.bgiframe();
        }
        if (options.source) {
      ...
      Combo.prototype.load = function(source) {
        ...
        return this.container.trigger('loaded');
      };
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        return _.delay(((function(_this) {
          return function() {
            return _this.container.trigger('itemSelect', {
              title: item.title
            });
          };
        })(this)), 10);
        ...
        for (_k = 0, _len2 = queryStringSplit.length; _k < _len2; _k++) {
          ...
          switch (this.matchBy) {
            ...
            case "wholeWord":
              filters.push({
                property: 'display',
                regex: new RegExp("(^|.* )(" + currentWord + ")(^|.* )", "i"),
                predicate: function(value) {
                  return this.regex.test(value);
                }
              });
      ...
      Combo.prototype.renderList = function(items, filters) {
        ...
        if (htmls.length) {
          ...
          return this.list[0].innerHTML = "<div class='empty-list'>" + this.emptyListText + "</div>";
        }
      };
      ...
      Combo.prototype.detach = function() {
    ...
    return $.fn.extend({
      combo: function() {
        ...
        value = this;
        this.each(function() {
          var $this, controller, data, isGetter, _value;
          $this = $(this);
          controller = $this.data('controller');
          if (!controller) {
            return $this.data('controller', (data = new Combo(this, option)));
          } else if (typeof option === 'string') {
            isGetter = !(__indexOf.call(setters, option) >= 0);
            if (isGetter && $(this).length !== 1) {
