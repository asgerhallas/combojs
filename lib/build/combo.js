...
(function() {
  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype._inputLabel = null;
      ...
      Combo.prototype.renderList = function(items, secondaryItems, filters) {
        ...
        if (this.showUnmatchedRawValue) {
          ...
          if (rawValue !== "" && this.getSelectedItemAndIndex().item.__isRawValueItem) {
            htmls.push("<li class='unmatched-raw-value'>" + (rawValue + this.getLabel(null, true)) + "</li>");
          }
        }
      ...
      Combo.prototype.renderItem = function(item, index, filters, className) {
        ...
        return "<li data-combo-id=\"" + index + "\" class=\"" + (classes.join(' ')) + "\">" + (text + this.getLabel(item)) + "</li>";
      };
      ...
      Combo.prototype.getLabel = function(item, isUnmatchedRawValue) {
        var label;
        if (isUnmatchedRawValue == null) {
          isUnmatchedRawValue = false;
        }
        label = typeof this.label === "function" ? this.label(item, isUnmatchedRawValue) : void 0;
        if (label != null) {
      ...
      Combo.prototype.toggleInputLabel = function() {
        var ref;
        if (this.isExpanded || this.getRawValue() === "") {
          if (this._inputLabel != null) {
            this._inputLabel.remove();
            return this._inputLabel = null;
          }
        } else {
          if (this._inputLabel != null) {
            return null;
          } else {
            return this._inputLabel = $(this.getLabel(this.getSelectedItem(), (ref = this.getSelectedItem()) != null ? ref.__isRawValueItem : void 0)).insertAfter(this.input);
          }
        }
      };
