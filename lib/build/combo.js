...
(function() {
  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.getLabel = function(item, inputfield) {
        var label;
        if (inputfield == null) {
          inputfield = false;
        }
        label = typeof this.label === "function" ? this.label(item) : void 0;
        if (label != null) {
      ...
      Combo.prototype.toggleInputLabel = function() {
        if (this.isExpanded) {
          ...
          if (this._inputLabel != null) {
            ...
            return this._inputLabel = $(this.getLabel(this.getSelectedItem())).insertAfter(this.input);
          }
        }
      };
