  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        if ((this.showUnmatchedRawValue && ((item.__isRawValueItem != null) && !item.__isRawValueItem)) || (this.input.val() === this.itemTitle(item) && this.itemTitle(item) === this.lastQuery) && !item.__isRawValueItem) {
          this.internalCollapse();
          return;
        }
