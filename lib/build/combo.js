  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.renderItem = function(item, index, filters, className) {
        ...
        classes = [className, this.onlyShowEnabled || this.itemEnabled(item) ? 'enabled' : 'disabled', (label = typeof this.label === "function" ? this.label(item, this.getRawValue()) : void 0) ? label.className : ""];
      ...
      Combo.prototype.getLabel = function(item) {
        var label;
      ...
      Combo.prototype.toggleInputLabel = function() {
        if (this.isExpanded || this.getRawValue() === "") {
          if (this._inputLabel != null) {
            ...
            return this.el.removeClass('input-label-added');
          }
        } else if (this._inputLabel === null && this.getLabel(this.getSelectedItem()) !== "") {
          this._inputLabel = $(this.getLabel(this.getSelectedItem())).insertAfter(this.input);
          return this.el.addClass('input-label-added');
        }
      };
