  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        console.log("selectItem", (_ref = this.input) != null ? _ref.val() : void 0, this.itemTitle(item), this.lastQuery, item);
        if (!this.itemEnabled(item) && !options.forced) {
          return;
        }
        if (this.itemTitle(item) === this.lastQuery) {
