  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.renderList = function(items, secondaryItems, filters) {
        ...
        if (this.showUnmatchedRawValue) {
          ...
          if (rawValue !== "" && !this.hasSelection()) {
            htmls.push("<li class='unmatched-raw-value " + (typeof this.label === "function" ? (ref = this.label(null, rawValue)) != null ? ref.className : void 0 : void 0) + "'>" + (rawValue + this.createLabel()) + "</li>");
          }
        }
      ...
      Combo.prototype.renderItem = function(item, index, filters, className) {
        ...
        classes = [className, this.onlyShowEnabled || this.itemEnabled(item) ? 'enabled' : 'disabled', typeof this.label === "function" ? (ref = this.label(item, this.getRawValue())) != null ? ref.className : void 0 : void 0];
      ...
      Combo.prototype.updateLabel = function() {
        if ((this.inputLabel != null) && (this.isExpanded || this.getRawValue() === "" || this.createLabel(this.getSelectedItem()) === "")) {
          this.inputLabel.remove();
          this.inputLabel = null;
          return this.el.removeClass('has-label');
        } else if (this.inputLabel === null && !this.isExpanded && this.createLabel(this.getSelectedItem()) !== "") {
          this.inputLabel = $(this.createLabel(this.getSelectedItem())).insertAfter(this.input);
