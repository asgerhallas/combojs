  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      function Combo(wrapper, options) {
        ...
        this.renderItemList = bind(this.renderItemList, this);
      ...
      Combo.prototype.setValue = function(value) {
        var ref;
        item((ref = _.find(this.source, x((function(_this) {
          return function() {
            return _this.itemValue(item) === value;
          };
        })(this)))) != null ? ref : _.find(this.secondary, x((function(_this) {
          return function() {
            return _this.itemValue(item) === value;
          };
        })(this))));
        ...
        return this.updateDynamicClassNames();
      };
      ...
      Combo.prototype.getSelectedItemAndIndex = function() {
        var i, index, item, j, len, len1, ref, ref1, ref2;
        ref = this.secondarySource;
        for (index = i = 0, len = ref.length; i < len; index = ++i) {
          ...
          if (this.itemTitle(item) === this.input.val()) {
            ...
            for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
              item = ref1[index];
              if ((ref2 = this.itemTitle(item) === this.input.val()) != null ? ref2 : {
                item: item,
                index: index
              }) {
                return {
      ...
      Combo.prototype.selectLi = function(li) {
        ...
        } else if (this.secondarySource[comboId]) {
          this.selectItem(this.secondarySource[comboId]);
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        if (!item.__isRawValueItem && (this.input.val() === this.itemTitle(item) && this.itemTitle(item) === this.lastQuery)) {
          this.internalCollapse();
          return;
        }
      ...
      Combo.prototype.renderFilteredList = function() {
        ...
        return this.renderList(this.source, filters, this.secondarySource);
      };
      ...
      Combo.prototype.renderList = function(items, filters, secondaryItems) {
        var htmls, rawValue;
        ...
        htmls = _.union(htmls, this.renderItemList(items, filters));
        htmls = _.union(htmls, this.renderItemList(secondaryItems, filters, 'secondary-source', items.length));
        if (htmls.length) {
          this.list.html(htmls.join(''));
          return $('li.secondary-source').first().addClass('first');
        } else {
          return this.list.html("<li class='disabled' data-combo-id='emptylist-item'>" + this.emptyListText + "</li>");
        }
      };

      Combo.prototype.renderItemList = function(items, filters, className, itemOffset) {
      ...
      Combo.prototype.renderItem = function(item, index, filters, className) {
        ...
        classes = [className, this.onlyShowEnabled || this.itemEnabled(item) ? 'enabled' : 'disabled'];
      ...
      Combo.prototype.updateDynamicClassNames = function() {
