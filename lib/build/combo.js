  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.renderList = function(items, filters, secondaryItems) {
        ...
        Array.prototype.push.apply(htmls, this.renderItemList(items, filters));
        Array.prototype.push.apply(htmls, this.renderItemList(secondaryItems, filters, 'secondary-source', items.length));
        if (htmls.length) {
