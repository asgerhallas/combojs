  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.renderList = function(items, secondaryItems, filters) {
        ...
        if (this.showUnmatchedRawValue) {
          ...
          if (rawValue !== "" && !this.hasSelection()) {
            htmls.push("<li class='unmatched-raw-value'>" + (rawValue + this.createLabel()) + "</li>");
          }
        }
      ...
      Combo.prototype.updateLabel = function() {
        if ((this._inputLabel != null) && (this.isExpanded || this.getRawValue() === "" || this.createLabel(this.getSelectedItem()) === "")) {
          this._inputLabel.remove();
          this._inputLabel = null;
          return this.el.removeClass('input-label-added');
        } else if (this._inputLabel === null && this.createLabel(this.getSelectedItem()) !== "") {
          this._inputLabel = $(this.createLabel(this.getSelectedItem())).insertAfter(this.input);
