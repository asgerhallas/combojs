...
(function() {
  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.linkSecondarySource = function(source) {
        this.secondarySource = source;
        this.ensureSelection();
        this.lastQuery = this.input.val();
        this.input.trigger('secondary-source-linked');
        return this;
      };
      ...
      Combo.prototype.getSelectedItemAndIndex = function() {
        ...
        ref = this.source.concat(this.secondarySource);
      ...
      Combo.prototype.selectLi = function(li) {
        var comboId, itemsArray;
        comboId = $(li).data('combo-id');
        if (comboId === 'emptylist-item') {
          this.internalCollapse();
          return;
        }
        itemsArray = this.source.concat(this.secondarySource);
        if (itemsArray[comboId]) {
          this.selectItem(itemsArray[comboId]);
