  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      function Combo(wrapper, options) {
        ...
        this.input = $("<input type='text' class='combo-input' autocomplete='off' disabled='disabled' spellcheck='" + this.spellcheck + "' " + (this.tabIndex != null ? 'tabindex=\'@tabIndex\'' : void 0) + "/>").bind({
        ...
        this.el = $(wrapper).addClass("combo-container").append(this.input).on('click', '.combo-list li', this.onListClick);
        this.button = $('<button class="combo-button" tabindex="-1" disabled="disabled" />').insertAfter(this.input).bind({
