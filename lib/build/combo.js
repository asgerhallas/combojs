  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      function Combo(wrapper, options) {
        ...
        this.itemTitle = __bind(this.itemTitle, this);
        this.itemDisplay = __bind(this.itemDisplay, this);
        this.itemEnabled = __bind(this.itemEnabled, this);
        this.itemLitra = __bind(this.itemLitra, this);
        this.itemValue = __bind(this.itemValue, this);
        for (key in options) {
      ...
      Combo.prototype.itemTitle = function(item) {
        ...
        if (item.__isRawValueItem) {
          ...
          return this.stripMarkup((_ref = evaluate(this.titleField, item)) != null ? _ref : this.itemDisplay(item));
        }
      };
      ...
      Combo.prototype.renderList = function(items, filters) {
        var htmls, index, item, rawValue, _i, _len;
        htmls = [];
