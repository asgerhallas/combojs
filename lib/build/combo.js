...
(function() {
  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.emptyFieldValidation = false;
      ...
      function Combo(wrapper, options) {
        ...
        this.getShowUnmatchedRawValueElement = bind(this.getShowUnmatchedRawValueElement, this);
        ...
        this.isUnmatchedRawValue = bind(this.isUnmatchedRawValue, this);
        ...
        if ((this.source != null) && this.source.length) {
      ...
      Combo.prototype.link = function(source) {
        this.source = source;
      ...
      Combo.prototype.itemValue = function(item) {
        if (this.isUnmatchedRawValue(item)) {
          return item.id;
        } else {
      ...
      Combo.prototype.itemModifier = function(modifier) {
        return (function(_this) {
          return function(item) {
            if (_this.isUnmatchedRawValue(item)) {
              return null;
            } else {
      ...
      Combo.prototype.isUnmatchedRawValue = function(item) {
        return item.id === "unmatched-raw-value";
      };
      ...
      Combo.prototype.selectLi = function(li) {
        ...
        if (comboId === 'emptylist-item') {
          ...
          this.selectItem((ref = this.source[$(li).data('combo-id')]) != null ? ref : this.showUnmatchedRawValue ? {
            id: "unmatched-raw-value",
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        if ((this.showUnmatchedRawValue && !this.isUnmatchedRawValue(item)) && (this.input.val() === this.itemTitle(item) && this.itemTitle(item) === this.lastQuery)) {
      ...
      Combo.prototype.renderList = function(items, filters) {
        var htmls, i, index, item, len, unmatchedRawValueElement;
        if (this.emptyFieldValidation) {
          this.input.toggleClass('empty', this.getRawValue() === "");
        }
        htmls = [];
        if (this.showUnmatchedRawValue) {
          unmatchedRawValueElement = this.getShowUnmatchedRawValueElement();
        ...
        for (index = i = 0, len = items.length; i < len; index = ++i) {
          ...
          htmls.push(this.renderItem(item, index, filters));
        }
        if (htmls.length) {
          return this.list.html(htmls.join(''));
        } else {
      ...
      Combo.prototype.renderItem = function(item, index, filters) {
        ...
        classes = [this.onlyShowEnabled || this.itemEnabled(item) ? 'enabled' : 'disabled'];
      ...
      Combo.prototype.collapse = function(options) {
        ...
        return this.list.hide(options.callback);
      };
      ...
      Combo.prototype.getShowUnmatchedRawValueElement = function() {
        var rawValue;
        ...
        return {
          useable: true,
          value: "<li class='enabled unmatched-raw-value last' data-combo-id='unmatched-raw-value'>" + rawValue + "</li>"
        };
      };
