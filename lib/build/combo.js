  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.itemValue = function(item) {
        if (this.showUnmatchedRawValue && item._isRawValueItem) {
          return null;
        } else {
      ...
      Combo.prototype.itemModifier = function(modifier) {
        return (function(_this) {
          return function(item) {
            if (_this.showUnmatchedRawValue && item._isRawValueItem) {
              return null;
            } else {
      ...
      Combo.prototype.selectLi = function(li) {
        ...
        if (comboId === 'emptylist-item') {
          ...
          this.selectItem((ref = this.source[$(li).data('combo-id')]) != null ? ref : this.showUnmatchedRawValue ? {
            _isRawValueItem: true,
            _rawValue: this.stripMarkup(this.getRawValue())
          } : null);
          return this.refocus();
        }
      };
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        if ((this.showUnmatchedRawValue && !item._isRawValueItem) && (this.input.val() === this.itemTitle(item) && this.itemTitle(item) === this.lastQuery)) {
