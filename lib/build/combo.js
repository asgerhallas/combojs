  ...
  (function($, window) {
    ...
    Combo = (function() {
      ...
      Combo.prototype.selectItem = function(item, options) {
        ...
        if ((this.showUnmatchedRawValue && !item.__isRawValueItem) || (this.input.val() === this.itemTitle(item) && this.itemTitle(item) === this.lastQuery) && !item.__isRawValueItem) {
      ...
      Combo.prototype.renderList = function(items, filters) {
        var htmls, i, index, item, len, rawValue;
